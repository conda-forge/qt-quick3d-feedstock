...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/qt-quick3d-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qt-quick3d-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add qt6-quick3d
# for installing globally
pixi global install qt6-quick3d
```
...
It is possible to list all of the versions of `qt6-quick3d` available on your platform:
...
```
pixi search qt6-quick3d --channel conda-forge
```
